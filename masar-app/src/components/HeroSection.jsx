import { HiOutlineRocketLaunch, HiOutlineArrowLeft, HiOutlinePlay } from 'react-icons/hi2';
...
const HeroSection = ({ onStartJourney }) => {
  ...
  return (
    <section
      ...
      style={{ minHeight: '805px', paddingTop: '120px' }}
    >
      ...
      >
        ...
        <div className="absolute bottom-[5%] right-[10%] w-[500px] h-[500px] bg-[#6D28D9] rounded-full blur-[150px] animate-glow-shift mix-blend-screen" style={{ animationDelay: '-6s' }} />
        ...
        <div className="absolute top-[65%] left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-[#6D28D9] to-transparent opacity-0 animate-laser-sweep" style={{ animationDelay: '4s' }} />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1 text-right">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#146EEC]/30 bg-[#146EEC]/5 mb-8 backdrop-blur-sm shadow-[0_0_20px_rgba(20,110,236,0.1)]">
              ...
              <span className="text-[#146EEC] text-sm font-semibold">مستقبل مخصص لك</span>
            </div>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-[52px] font-bold leading-[1.3] mb-6 text-white drop-shadow-md">
              ...
              <span className="block">
                المهني <span className="text-[#146EEC] drop-shadow-[0_0_15px_rgba(20,110,236,0.4)]">بذكاء</span>
              </span>
            </h1>

            {/* Subtitle */}
            <p className="text-[#94A3B8] text-base md:text-lg leading-relaxed mb-10 max-w-[500px]">
              مسار يساعدك على اكتشاف شغفك، وبناء خريطة طريق مخصصة لك، والوصول إلى الاحتراف من خلال رحلة تعليمية منظمة تدعمها أحدث تقنيات التعليم.
            </p>
