...
const AdminLogin = ({ onLoginSuccess }) => {
  ...
  return (
    <div className="min-h-screen bg-[#101822] flex items-center justify-center p-4" dir="rtl">
      <div className="bg-[#0B1120] border border-[#1E293B] rounded-2xl p-8 w-full max-w-md shadow-2xl animate-fade-in">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-[#94A3B8] text-sm mt-2">يرجى إدخال كلمة المرور للمتابعة</p>
        </div>
